...
class DepanController extends Controller
{
    ...
    public function kalenderAkademik()
    {
        ...
        $arrNewSku = array();
        $incI = 0;
        foreach ($kalenderAkademiks as $jsonka => $arrData) {
            $arrNewSku[$incI]['id'] = $jsonka;
            $arrNewSku[$incI]['title'] = $arrData['title'];
            $arrNewSku[$incI]['start'] = $arrData['start'];
            $arrNewSku[$incI]['end'] = $arrData['end'];
            $arrNewSku[$incI]['color'] = $arrData['color'];
            $arrNewSku[$incI]['url'] = $arrData['url'];
            $incI++;
        }
        ...
        return view('depan.kalender-akademik', [
            'kalender' =>  $encodedSku,
            'kalenderakademik' => $kalenderAkademiks
        ]);
    }

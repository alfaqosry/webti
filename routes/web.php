...
use App\Http\Controllers\FavoritbukuController;
...
Route::get('/fasilitas', function () {
    return view('depan.fasilitaskita');
})->name('fasilitasdepan');
...
Route::get('/akreditasi', [DepanController::class, 'akreditasi'])->name('akreditasi');
...
Route::group(['middleware' => ['auth']],function () {
    ...
    //   ebook
        Route::prefix('/e-book')->name('ebook.')->group(function () {
        Route::get('/', [EbookController::class, 'index'])->name('index');
        Route::get('/show/{id}', [EbookController::class, 'show'])->name('show');
        Route::get('/bacaonline/{id}', [EbookController::class, 'bacaonline'])->name('bacaonline');
        Route::get('/caribuku', [EbookController::class, 'caribuku'])->name('caribuku');


        Route::get('/add-favorit/{id}', [FavoritbukuController::class, 'addFavorit'])->name('addFavorit');
        Route::get('/remove-favorit/{id}', [FavoritbukuController::class, 'destroy'])->name('removeFavorit');
...
Route::group(['middleware' => ['auth', 'role:admin']],function () {
    ...
    // Perpustakaan 
    Route::prefix('home/perpustakan/')->name('perpustakaan.')->group(function () {
        Route::get('/', [PerpustakaanController::class, 'index'])->name('index');
        Route::get('/create', [PerpustakaanController::class, 'create'])->name('create');
        Route::post('/store', [PerpustakaanController::class, 'store'])->name('store');
        Route::get('/show/{id}', [PerpustakaanController::class, 'show'])->name('show');
        Route::get('/edit/{id}', [PerpustakaanController::class, 'edit'])->name('edit');
        Route::post('/update/{id}', [PerpustakaanController::class, 'update'])->name('update');
        Route::get('/delete/{id}', [PerpustakaanController::class, 'destroy'])->name('delete');
    });
    ...
    Route::prefix('home/kalender-akademik/')->name('kalender-akademik.')->group(function () {
        ...
        Route::get('/delete/{id}', [KalenderakademikController::class, 'destroy'])->name('delete');
    });

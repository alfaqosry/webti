                ...
                <li class="nav-item dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                        <div class="avatar-sm">
                            ...
                            <img src="{{ asset('belakang/assets/img/profile.jpg') }}" alt="Nama Anda Sini"
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    <div class="avatar-lg">
                                        @if (Auth::user()->image == null)
                                        <img src="{{ asset('belakang/assets/img/profile.jpg') }}" alt="image profile"
                            ...
                            <li>
                                ...
                                <a class="dropdown-item" href="{{ route('user.edit', Auth::user()->id) }}">My
                                    Profile</a>
                                ...
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                    onclick="if (confirm('Logout?')) { event.preventDefault(); document.getElementById('logout-form').submit(); } else { return false; }">
                                    Logout
                                </a>
                                <!-- Form Logout -->

    ...
    <div class="container py-5 mb-5">
        <div class="bg-white">
            <div class="owl-carousel vendor-carousel">
                ...
                @else
                <img src="{{ asset('depan/img/logo-up.png') }}" alt="">
                <img src="{{ asset('depan/img/unp3.png') }}" alt="">
                <img src="{{ asset('depan/img/itb2.png') }}" alt="">
                <img src="{{ asset('depan/img/Logo OK (1).png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 footer-about">
                <div
                    ...
                    <a href="{{ route('index') }}" class="navbar-brand">
                        <h1 class="m-0 text-white">Teknik Informatika</h1>
                    </a>
                    <p class="mt-3 mb-4">Menjadi Program Studi Teknik Informatika Yang Berkualitas dan Berdaya Saing melalui
        ...
        <div class="row justify-content-end">
            <div class="col-lg-8 col-md-6">
                <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                    <p class="mb-0">&copy; <a class="text-white border-bottom" href="{{ route('index') }}">Teknik Informatika UP

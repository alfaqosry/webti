...
<head>
    ...
    <meta content="{{ $keywords ?? " Teknik Informatika Universitas Pahlawan Tuanku Tambusai" }}" name="keywords">
    <meta content="{{ $description ?? " Teknik Informatika Universitas Pahlawan Tuanku Tambusai" }}" name="description">
...
<body>
    ...
    <!-- Footer Start -->
    @include('components.partials.footer-ebook')
    <!-- Footer End -->

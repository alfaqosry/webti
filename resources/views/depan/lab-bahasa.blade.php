<x-templates.depan>
    <x-slot name="appname">Laboratorium Bahasa Program Studi Teknik Informatika Universitas Pahlawan Tuanku Tambusai</x-slot>
    <x-slot name="title">LABORATORIUM BAHASA</x-slot>

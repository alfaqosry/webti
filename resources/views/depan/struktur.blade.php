<x-templates.depan>
    <x-slot name="appname">Struktur Organisasi Teknik Informatika Universitas Pahlawan Tuanku Tambusai</x-slot>
                    ...
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            ...
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href="https://www.instagram.com/{{ $kaprodi->instagram }}" target="_blank"><i
                                        class="fab fa-instagram fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href="https://www.linkedin.com/in/{{ $kaprodi->linkdin }}"><i
                                        class="fab fa-linkedin-in fw-normal"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a href="{{ route('dosen-staff-show', $kaprodi->slug) }}"><h4 class="text-primary">{{ \Str::upper($kaprodi->nama) }}</h4></a>
                            <p class="text-uppercase m-0">Ketua Prodi</p>
                        </div>
                    </div>
                </div>
            </div>

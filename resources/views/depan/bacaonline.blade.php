...
<script src="{{asset('pdfjs/build/pdf.mjs')}}" type="module"></script>
  ...
  <!-- <script src="viewer.mjs" type="module"> -->
...
const defaultOptions = {
  ...
  debuggerSrc: {
    value: "{{asset('pdfjs/web//debugger.mjs')}}",
  ...
  standardFontDataUrl: {
    value: "{{asset('pdfjs/web/standard_fonts/')}}",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: "{{asset('pdfjs/build/pdf.worker.mjs')}}",
    kind: OptionKind.WORKER
  }
};
...

{
  defaultOptions.defaultUrl = {
    value: "{{ asset('storage/'.$buku->pdf_buku) }}",
    kind: OptionKind.VIEWER
  };
  defaultOptions.sandboxBundleSrc = {
    value: "{{asset('pdfjs/build/pdf.sandbox.mjs')}}",
    kind: OptionKind.VIEWER
  };
